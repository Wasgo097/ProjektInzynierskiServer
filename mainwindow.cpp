...
void MainWindow::StartListeners(const QString &serialport){
    if(_server!=nullptr){
        _server->StartListeners(serialport);
    }
}
...
void MainWindow::on_SaveLogBtn_clicked(){
    qDebug()<<"ToDo void MainWindow::on_SaveLogBtn_clicked()";
...
void MainWindow::on_StopBtn_clicked(){
    qDebug()<<"ToDo void MainWindow::on_StopBtn_clicked()";
//    StopManager();
//    StopListeners();
}
